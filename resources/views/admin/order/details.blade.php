...
<div class="main-content-inner">
    <div class="main-content-wrap">
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            @if($order->status == 'delivered')
                                <span class="budge bg-success">Delivered</span>
                            @elseif($order->status == 'canceled')
                                <span class="budge bg-danger">Canceled</span>
                            @else
                                <span class="budge bg-warning">Ordered</span>
                            @endif
                        </td>
                    </tr>
                </table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="pname ">
                                ...
                                <div class="name">
                                    <a href="{{ route("shop.detail", ["slug" => $item->product->slug]) }}" target="_blank"
        ...
        <div class="wg-box mt-5">
            ...
            <div class="my-account__address-item col-md-6">
                <div class="my-account__address-item__detail">
                    <form action="{{ route('order.updateStatus', ['id_order' => $order->id]) }}" method="POST">
                        @csrf
                        <fieldset>
                            <div class="row">
                                <div class="col-md-9">
