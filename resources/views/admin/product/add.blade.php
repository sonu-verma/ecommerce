        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('product.store') }}">
            ...
            <div class="wg-box">
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="text" placeholder="Enter product name" name="name" id="name" tabindex="0" value="{{ old('name')}}" >
                    @error('name')
                        <div class="text-tiny">
                ...
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="text" placeholder="Enter product slug" name="slug" id="slug" tabindex="0"  value="{{ old('slug')}}">
                ...
                <fieldset class="shortdescription">
                    ...
                    <textarea class="mb-10 ht-150" name="short_desc"
                        placeholder="Short Description" tabindex="0" >{{ old('short_desc')}}</textarea>
                        @error('short_desc')
                            <div class="text-tiny">
                                <span class="error">{{$message}}</span>
                            </div>
            ...
            <div class="wg-box">
                ...
                <fieldset>
                    ...
                    <div class="upload-image mb-16">
                        ...
                        <div class="item galaryItems" id="galUpload" style="display: none">
                        </div> 
                    </div>
                    @error('images')
                        <div class="text-tiny">
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="stock_status">
                                <option value="instock" {{ 'instock' == old('stock_status') ?'selected': ''}}>InStock</option>
                                <option value="outofstock" {{ "outofstock" == old('stock_status') ?'selected': ''}}>Out of Stock</option>
                            </select>
                        </div>
                        @error('stock_status')
                            <div class="text-tiny">
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="featured">
                                <option value="0" {{ '0' == old('featured') ?'selected': ''}}>No</option>
                                <option value="1" {{ '1' == old('featured') ?'selected': ''}}>Yes</option>
                            </select>
                        </div>
                        @error('featured')
                            <div class="text-tiny">
